...
I created a backup vault, backup plan with backups every morning 4:00 o'clock, deleted after 7 days, backups implemented to resources tagged with key: backup and value: dobackup.

- The following has been added to the template right after the EC2 instance creation:

```yaml
  SanteriBackupVault:
    Type: "AWS::Backup::BackupVault"
    Properties:
      BackupVaultName: "SanteriBackupVault"

  SanteriBackupPlan:
    Type: "AWS::Backup::BackupPlan"
    Properties:
      BackupPlan:
        BackupPlanName: "SanteriBackupPlan"
        ...
        BackupPlanRule:
          -
            ...
            TargetBackupVault: !Ref SanteriBackupVault
            ScheduleExpression: "cron(0 4 * * ? *)"
            Lifecycle:
              DeleteAfterDays: 7
    DependsOn: SanteriBackupVault

  TagBasedBackupSelection:
    Type: "AWS::Backup::BackupSelection"
    Properties:
      BackupPlanId: !Ref SanteriBackupPlan
      BackupSelection:
        SelectionName: "TagBasedBackupSelection"
        IamRoleArn: !Sub "arn:aws:iam::${AWS::AccountId}:role/LabRole"
        ListOfTags:
          -
            ConditionType: "STRINGEQUALS"
            ConditionKey: "backup"
            ConditionValue: "dobackup"     
    DependsOn: SanteriBackupPlan
```
...
- You can verify that the backup vault, plan, and tag based selection are created from the CLI by running:
```bash
